...
mavenPublishing {
    coordinates("one.wabbit", "scala-std-data-hash-murmur", "0.0.1")
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("scala-std-data-hash-murmur")
        description.set("scala-std-data-hash-murmur")
        url.set("https://github.com/wabbit-corp/scala-std-data-hash-murmur")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/wabbit-corp/scala-std-data-hash-murmur")
            connection.set("scm:git:git://github.com/wabbit-corp/scala-std-data-hash-murmur.git")
            developerConnection.set("scm:git:ssh://git@github.com/wabbit-corp/scala-std-data-hash-murmur.git")
        }
    }
}
